...
int main(int argc, char** argv){
	...
	Eigentransformation::createEigenSpace(trainingPhotos,pPhotos,avgPhoto,vecsPhotos,valsDiagPhotos,eigenPhotos);
	cerr << "creating eigensketches" << endl;
	Eigentransformation::createEigenSpace(trainingSketches,pSketches,avgSketch,vecsSketches,valsDiagSketches,eigenSketches);
